...
var ROLL = (function() {
	...
	function load(canvas)
	{
		...
		$($("a[href|='#']")).hover(
		  function() {
			$( this ).append( $( "<span>&nbsplike it?</span>" ) );
		  }, function() {
	...
	function changeBackground() {
		if (bgStatus) {
			$("#navigator").removeClass('ocean1');
			$("#navigator").addClass('ocean2');	
			bgStatus = false;
		} else {
			$("#navigator").removeClass('ocean2');
			$("#navigator").addClass('ocean1');
			bgStatus = true;
		}
