...
namespace NGO.Pad.JFiles
{
	...
	public partial class Navigator : UserControl, INavigator
	{
		...
		public Navigator(IFiles browser)
		{
			...
			refresh = new RefreshNode(global::NGO.Pad.JFiles.Resource1.icon2, this, browser);
		...
		public void AddPathNode(string name, string path) {
			...
			newNode.Tag = path;
			var newSplitor = new ImageNode(global::NGO.Pad.JFiles.Resource1.icon3, this);
	...
	{
		public Control Splitor {set; get;}
